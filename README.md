...
## Environments
- Preview: https://main--aem-edge-getting-started-local--terinmez-at-adobe.aem.page/
- Live: https://main--aem-edge-getting-started-local--terinmez-at-adobe.aem.live/
...
1. Open the `aem-edge-getting-started-local` directory in your favorite IDE and start coding :)
